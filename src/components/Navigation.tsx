...
const Navigation = () => {
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm py-6">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-4 md:gap-0">
          <Link to="/" className="text-xl md:text-2xl font-heading text-primary font-bold">Jordan✿Does✿Design<span className="text-yellow-500">✿</span>Does<span className="text-secondary">✦</span>Design
          </Link>
