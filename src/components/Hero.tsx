...
const Hero = () => {
  ...
  return <section className="pt-32 pb-16 md:pb-24 px-6">
      <div className="container mx-auto">
        <div className="flex flex-col-reverse lg:flex-row gap-1 lg:gap-[50px] items-center lg:justify-center">
          {/* Text Content */}
          <div className="w-full lg:max-w-[375px]">
            ...
            <div className="overflow-hidden whitespace-nowrap mb-8">
              <div className="inline-block animate-marquee">
                <span className="text-lg md:text-2xl text-primary font-medium px-[30px]">{services}</span>
                <span className="text-lg md:text-2xl text-primary font-medium">{services}</span>
              </div>
            </div>
